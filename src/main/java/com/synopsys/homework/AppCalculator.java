...
/**
 * Main class that takes expression to be evaluated and optional logging level as command line arguments
 * USAGE: java -jar integer-calculator-program-0.0.1-SNAPSHOT-jar-with-dependencies.jar <INPUT-EXPRESSION> <OPTIONAL-LOGGING-LEVEL>";
 */
public class AppCalculator {
	...
	public static void main(String[] args) throws IOException, CalculatorException, NullPointerException {
		...
		LOG.debug("Expression to be evaluated: {}", expression);
...
/**
 * This method takes the expression to be evaluated and returns the integer result 
 * 
 ...
 */
	protected static Integer evaluate(String expression) throws CalculatorException {
		...
		/*
		 * An input string expression is fed to Lexer generated by antl4 using grammar file 
		 * As per the parse rule defined in the grammar file, Parser can recognize the string with the help of tokens tagged by the lexer
